    ...
    >
        ...
        >
            <div class="container max-w-5xl mx-auto px-14">
                ...
                <div class="w-5/6 my-10 ml-6">
                    <h3 class="text-gray-300">
                        ...
                        <strong class="text-white"
                            >faster package installations & greater
                            security</strong
                        >
                ...
                <div class="hidden sm:block opacity-50 z-0">
                    ...
                    <div
                        class="shadow-xl w-80 h-80 rounded-full ml-8 -mt-96"
                    ></div>
                </div>
                <div class="text-white relative">
                    ...
                    <div
                        class="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-1 sm:gap-5 uppercase"
                    >
                        <div
                        ...
                        >
                            ...
                            <div>
                                <span>Angular</span>
                                <span class="text-xs text-blue-300 block"
                                    >Typescript</span
                                >
                            </div>
                            <div>
                        ...
                        >
                            ...
                            <img
                                class="w-9"
                                src="https://www.svgrepo.com/show/405427/flag-for-flag-bolivia.svg"
                                alt=""
                            />
                            <div>
                                <span>ATLAS</span>
        ...
        <div class="p-4">
            ...
            <div class="text-center">
                ...
                <p
                    class="max-w-xs py-4 font-light text-gray-500 text-md dark:text-gray-400"
                >
            ...
            >
                ...
                <a
                    href="https://www.linkedin.com/in/ynv-yovanramonyauneenovore/"
                >
                    <svg
                        width="30"
                        height="30"
