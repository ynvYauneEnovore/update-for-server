...
<template>
    ...
    <div
        ...
        <div class="bg-gradient-to-br from-indigo-900 to-black min-h-screen overflow-auto">

            <div class="container max-w-5xl mx-auto px-14">
                <div class="w-4/5">
                    <h1 class="mt-5 text-white text-6xl font-bold">
                        The fastest, most secure dev environment <br /><span class="text-blue-400">on the planet.</span>
                    </h1>
                </div>
                <div class="w-5/6 my-10 ml-6">
                    <h3 class="text-gray-300">
                        Create, edit & deploy fullstack apps with <br />
                        <strong class="text-white">faster package installations & greater
                            security</strong>
                ...
                <div class="text-white relative">
                    ...
                    <div class="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-1 sm:gap-5 uppercase">
                        ...
                        <a href="Bolivia">
                            <div
                                class="group flex items-center bg-green-900 bg-opacity-40 shadow-xl gap-5 px-6 py-5 rounded-lg ring-2 ring-offset-2 ring-offset-green-800 ring-cyan-700 mt-5 cursor-pointer hover:bg-green-900 hover:bg-opacity-100 transition">
    ...
    <div class="p-4">
        ...
        <div class="text-center">
            ...
            <p class="max-w-xs py-4 font-light text-gray-500 text-md dark:text-gray-400">
                Systems developer committed to excellence. Creating advanced
                and efficient solutions to drive technological progress.
            </p>
        </div>
