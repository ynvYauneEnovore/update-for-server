...
<template>
    <nav class="bg-white border-gray-200 dark:bg-gray-900">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            <a href="https://yovanenovore.tech" class="flex items-center">
                <img src="/img/ynv.png" class="h-8 mr-3" alt="Flowbite Logo" />
                <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">YNV</span>
            </a>
            ...
            <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-language">
                <ul
                    ...
                    <li>
                        <a href="#"
                            class="block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Servicios</a>
                    </li>
                    <li>
                        <a href="#"
                            class="block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Pricios</a>
                    </li>
                    <li>
                        <a href="#"
                            class="block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Contactos</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div
        ...
        <div class="to-black overflow-auto">
            ...
            <div class="container max-w-5xl mx-auto px-14">
                <div class="w-4/5">
                    <h1 class="mt-12 text-black text-6xl font-bold">
                ...
                <div class="text-white relative">
                    ...
                    <div class="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-1 sm:gap-5 uppercase">
                        ...
                        <div
                            ...
                            <div>
                                <span>Vue</span>
                                <span class="text-xs text-blue-300 block">v3 (beta)</span>
                            </div>
                            <div>
                                <i
                                    class="fa fa-chevron-right opacity-0 group-hover:opacity-100 transform -translate-x-1 group-hover:translate-x-0 block transition"></i>
                        ...
                        <a href="Bolivia">
                            <div
                                class="group flex items-center bg-green-900 bg-opacity-400 shadow-xl gap-5 px-6 py-5 rounded-lg ring-2 ring-offset-2 ring-offset-green-800 ring-cyan-700 mt-5 cursor-pointer hover:bg-green-900 hover:bg-opacity-100 transition">

                                <img class="w-9" src="https://www.svgrepo.com/show/405427/flag-for-flag-bolivia.svg"
                                    alt="" />
                                <div>
                                    <span>ATLAS</span>
                                    <span class="text-xs text-blue-300 block">Bolivia</span>
                                </div>
                                <div>
                                    <i
                                        class="fa fa-chevron-right opacity-0 group-hover:opacity-100 transform -translate-x-1 group-hover:translate-x-0 block transition"></i>
                    ...
                    <svg width="30" height="30" fill="currentColor"
                        ...
                        <div class="w-full max-w-screen-xl mx-auto p-4 md:py-8">
                            ...
                            <span class="block text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a
                                    ...
                                    class="audio-element">Todos los Derechos Reservados.</span></span>
                        </div>
